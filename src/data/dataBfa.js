export const dataBfa= {
    ...
    class: {
        ...
        "Void Elf": ["Rogue", "Hunter", "Mage", "Priest", "Warlock", "Monk"],
        "Lightforged Draenei": ["Hunter", "Mage", "Priest", "Paladin", "Warrior"],
        "Dark Iron Dwarf": ["Hunter", "Mage", "Paladin", "Priest", "Rogue", "Shaman", "Warlock", "Warrior"],
        "Kul Tiran": ["Druid", "Hunter", "Mage", "Priest", "Rogue", "Shaman", "Warrior", "Monk"],
        "Mechagnome": ["Hunter", "Mage", "Priest", "Rogue", "Warlock", "Warrior", "Monk"],
        "Nightborne": ["Hunter", "Mage", "Priest", "Rogue", "Warlock", "Warrior", "Monk"],
        "Highmountain Tauren": ["Druid", "Hunter", "Shaman", "Warrior", "Monk"],
        "Mag'har Orc": ["Hunter", "Mage", "Priest", "Rogue", "Shaman", "Warrior", "Monk"],
        "Zandalari Troll": ["Druid", "Hunter", "Mage", "Paladin", "Priest", "Rogue", "Shaman", "Warrior", "Monk"],
        "Vulpera": ["Hunter", "Mage", "Priest", "Rogue", "Shaman", "Warlock", "Warrior", "Monk"]
    },
    spec: {
